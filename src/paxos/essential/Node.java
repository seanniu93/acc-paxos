 ...
 */
public class Node extends Thread implements EssentialProposer, EssentialAcceptor, EssentialLearner, EssentialListner{
    ...
    public Node(EssentialMessengerImpl essentialMessengerImpl, String hostName, int quorumSize, int portNumber, LocationInfo locationInfo)
    {
    ...
    public boolean isActive() {return essentialProposerImpl.isActive();}
